...
if ($mb2scheme = theme_mb2nl_mb2fields_filed('mb2scheme')) {
    $headercolorscheme = $mb2scheme;
} else {
    $headercolorscheme = theme_mb2nl_theme_setting($PAGE, 'headercolorscheme');
}
...
$html .= '<h1 class="course-heading">' . theme_mb2nl_format_str($COURSE->fullname) . '</h1>';
...
if ($rating) {
    $html .= '<a href="#course-csection-reviews" class="out-navitem' . $metadcls . '" data-tabid="reviews">';
...
if ($ecinstructor) {
    ...
    $html .= '<a href="#course-csection-instructor" class="out-navitem' . $metadcls . '" data-tabid="instructor">';
...
$html .= '<div class="sidebar-inner2">';
$html .= '<div class="fake-block block-video">';
$html .= '<div class="video-banner position-relative lazy" data-bg="' . theme_mb2nl_course_image_url($COURSE->id, true) . '">';
...
$html .= theme_mb2nl_moreless(theme_mb2nl_activities_list(), 106);
$html .= '</div>';
