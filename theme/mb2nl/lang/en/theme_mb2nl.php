...
$string['coursetags'] = 'Subjects covered in this course';
...
$string['ctaglink'] = 'Tags link to courses page';
...
$string['ectagsincontent'] = 'Display course tags in content area';
...
$string['headerimgstc'] = 'Semi-transparent color layer over background image';
...
$string['quickfields']  = 'Custom fields to display in the quick view';
$string['quickfields_desc']  = 'Comma-separated custom field shortnames, for example:
<pre>level,effort</pre>';
$string['quickintrolimit'] = 'Course intro text character limit';
$string['quicklinks'] = 'Quick links';
$string['quickskillimit'] = 'Skill name character limit';
$string['quickview'] = 'Quick view';
$string['quickviewfe'] = 'Quick view';
